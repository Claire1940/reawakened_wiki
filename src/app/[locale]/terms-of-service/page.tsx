...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Reawakened Wiki",
    description: "Read the Terms of Service for Reawakened Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    keywords: [
      'terms of service',
      "Reawakened Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Reawakened Wiki",
      description: "Terms and conditions for using Reawakened Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Reawakened Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Reawakened Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Reawakened Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Reawakened Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Reawakened". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and leveling strategies</li>
              <li>Class builds and trait guides</li>
              <li>Gate and dungeon information</li>
              <li>Boss guides and drop tables</li>
              <li>Active codes and rewards</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Reawakened Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Reawakened. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Reawakened Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Reawakened. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game updates and patches may change without notice. We are not responsible for game access issues or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              ...
              you and Reawakened Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@reawakened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@reawakened.wiki</a>
            </p>
            <p>
