...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Reawakened Wiki',
    description: 'Copyright and intellectual property information for Reawakened Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Reawakened Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Reawakened Wiki',
      description: 'Copyright and intellectual property information for Reawakened Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Reawakened Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Reawakened Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Reawakened Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Vayron Studios</strong> - Creators of the Reawakened game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Reawakened</strong> - Trademark of Vayron Studios</li>
              <li><strong>Reawakened Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Reawakened Wiki.
            </p>
            ...
            <p>
              ...
              Reawakened Wiki<br />
              Email: <a href="mailto:dmca@reawakened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@reawakened.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Reawakened Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Reawakened Wiki (reawakened.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@reawakened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@reawakened.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@reawakened.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@reawakened.wiki</a>
            </p>
            <p>
